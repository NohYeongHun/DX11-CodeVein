...
HRESULT CLoader_Debug::Loading_Resource(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	if (FAILED(Add_Prototype_Terrain(pDevice, pContext, pGameInstance)))
	{
		MSG_BOX(TEXT("Create Failed Loading : Debug Terrain "));
		return E_FAIL;
	}

	if (FAILED(Add_Prototype_Map(pDevice, pContext, pGameInstance)))
	{
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Map "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_Navigation(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Navigation"));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_Camera_Free(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Camera_Free "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_Camera_Player(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Camera_Player "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_Player(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Player "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_QueenKnight(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug QueenKnight "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_WolfDevil(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug WolfDevil "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_SlaveVampire(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug SlaveVampire "));
		return E_FAIL;
	}
	...
	if (FAILED(Add_Prototype_SkyBox(pDevice, pContext, pGameInstance)))
	{
		...
		MSG_BOX(TEXT("Create Failed Loading : Level Debug SkyBox "));
		return E_FAIL;
	}

	if (FAILED(Add_Prototype_Effect(pDevice, pContext, pGameInstance)))
	{
		CRASH("Create Effect Failed");
		MSG_BOX(TEXT("Create Failed Loading : Level Debug Effect "));
		return E_FAIL;
	}
...
// 1. Game 에서 사용할 Model.
HRESULT CLoader_Debug::Add_Prototype_Map(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
...
HRESULT CLoader_Debug::Add_Prototype_Navigation(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
...
// 1.
HRESULT CLoader_Debug::Add_Prototype_Player(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	// Player Prototype 생성.
	/*if (FAILED(pGameInstance->Add_Prototype(ENUM_CLASS(m_eCur_Level)
...
HRESULT CLoader_Debug::Add_Prototype_QueenKnight(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	_matrix		PreTransformMatrix = XMMatrixIdentity();
...
HRESULT CLoader_Debug::Add_Prototype_WolfDevil(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	_matrix		PreTransformMatrix = XMMatrixIdentity();
	PreTransformMatrix = XMMatrixScaling(0.01f, 0.01f, 0.01f) * XMMatrixRotationY(XM_PI);
...
HRESULT CLoader_Debug::Add_Prototype_SlaveVampire(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
...
HRESULT CLoader_Debug::Add_Prototype_Terrain(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	// Terrain 용도 텍스쳐.
...
HRESULT CLoader_Debug::Add_Prototype_Camera_Free(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
	// Free 시점 카메라 생성.
...
HRESULT CLoader_Debug::Add_Prototype_Camera_Player(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
...
HRESULT CLoader_Debug::Add_Prototype_SkyBox(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
...
HRESULT CLoader_Debug::Add_Prototype_Effect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CGameInstance* pGameInstance)
{
