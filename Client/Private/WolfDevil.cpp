...
void CWolfDevil::Start_Dissolve(_float fDuration)
{
    if (fDuration == 0.f)
...
void CWolfDevil::ReverseStart_Dissolve(_float fDuration)
{
    if (fDuration == 0.f)
