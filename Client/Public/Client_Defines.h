...
namespace Client
{
	...
	enum TEXTURE { TEXTURE_DIFFUSE, TEXTURE_GRADIENT, TEXTURE_GRADIENT_ALPHA, TEXTURE_MASK, TEXTURE_NOISE, TEXTURE_OTHER, TEXTURE_END };

	enum class TRAIL_DIFFUSE : _uint { SWORD = 0, THICK_BLOOD = 1, BLOOD = 2, NONE };
	enum class ANIMESH_SHADERPATH : _uint { DEFAULT = 0, NORMAL = 1, DISSOLVE = 2, DISSOLVE_REVERSE = 3, NONE };
	enum class MESH_SHADERPATH : _uint { DEFAULT = 0, NORMAL = 1, DISSOLVE = 2, NONE };
	...
	{
		DEFAULT = 0, QUEENKNIGHTWARP = 1, EXPLOSION = 2,QUEENKINGHT_PARTICLE = 3, DEBUG = 4,
		NONE
	};
