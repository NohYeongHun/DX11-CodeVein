...
namespace Client
{
	...
	enum class MESH_SHADERPATH : _uint { DEFAULT = 0, NORMAL = 1, DISSOLVE = 2, BLOOD_PILLARA = 3, BLOOD_PILLARB = 4, BLOOD_PILLARC = 5, SWORD_WIND = 6, SHADOW = 7, BLOOD_CIRCLE = 8,  NONE };
