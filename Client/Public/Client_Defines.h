...
namespace Client
{
	...
	enum class POSTEX_SHADERPATH : _uint { 
		...
		MONSTERHITFLASH = 10, MONSTERHP_PROGRESSBAR = 11, QUEENKNIGHT_ENCOUNTER = 12, NONE
	};


	enum class EFFECTPOSTEX_SHADERPATH : _uint
	{
		DEFAULT = 0, HITFLASH = 1, MONSTER_LINESLASH = 2, RENKETSU_LINESLASH = 3, NONE
	};
	...
	enum class EFFECTPOSTEX_DISTORTIONSHADERPATH : _uint
	{
		DEFAULT = 0, NONE
	};
