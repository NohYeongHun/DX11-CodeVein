...
namespace Client
{
	...
	enum TEXTURE { TEXTURE_DIFFUSE, TEXTURE_GRADIENT, TEXTURE_GRADIENT_ALPHA, TEXTURE_MASK,  TEXTURE_OTHER, TEXTURE_NOISE, TEXTURE_END };
	...
	enum class MESH_SHADERPATH : _uint { DEFAULT = 0, NORMAL = 1, DISSOLVE = 2, BLOOD_PILLARA = 3, BLOOD_PILLARB = 4, BLOOD_PILLARC = 5, NONE };
