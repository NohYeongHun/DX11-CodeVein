...
NS_BEGIN(Client)
class CBlood_PillarA final : public CPartObject
{
public:
...
public:
    ...
    }PILLARA_ACTIVATE_DESC;

private:
    explicit CBlood_PillarA(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    explicit CBlood_PillarA(const CBlood_PillarA& Prototype);
    virtual ~CBlood_PillarA() = default;
...
private:
    PILLARA_ACTIVATE_DESC m_ActivateDesc = {};
#pragma endregion
...
public:
    static CBlood_PillarA* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
